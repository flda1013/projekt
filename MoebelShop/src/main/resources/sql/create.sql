...
--CREATE TABLE lieferung(id NUMBER(4) NOT NULL PRIMARY KEY, liefernr VARCHAR2(12), transport_art_fk NUMBER(1), erzeugt TIMESTAMP NOT NULL, aktualisiert TIMESTAMP)CACHE;
...
--ALTER TABLE bestellung_lieferung ADD CONSTRAINT bestellung_lieferung__bestellung_fk FOREIGN KEY (bestellung_fk) REFERENCES bestellung;
--ALTER TABLE bestellung_lieferung ADD CONSTRAINT bestellung_lieferung__lieferung_fk FOREIGN KEY (lieferung_fk) REFERENCES lieferung;